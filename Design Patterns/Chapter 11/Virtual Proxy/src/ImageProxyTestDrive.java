...
import java.util.*;
/*
 * Application that displays your favorite compact disc cover.
 * Your application should display something while you're waiting for the image to load.
 * The Virtual Proxy can stand in place of the icon, manage the background loading, display message:
 * 		'Loading CD cover, please wait...'. Once the image is loaded, the proxy delegates the display
 * 		to the icon.
 * */
